...
class DashboardPage(ctk.CTkFrame):
    def __init__(self, parent):
        ...
        ctk.CTkButton(nav_frame, text="Profile", command=lambda: self.parent.show_page("ProfilePage")).pack(side="left", padx=5)
        ctk.CTkButton(nav_frame, text="History", command=lambda: self.parent.show_page("HistoryPage")).pack(side="left", padx=5)
        ctk.CTkButton(nav_frame, text="Resources", command=lambda: self.parent.show_page("ResourcesPage")).pack(side="left", padx=5)
        ctk.CTkButton(nav_frame, text="About", command=lambda: self.parent.show_page("AboutPage")).pack(side="left", padx=5)
        ctk.CTkButton(nav_frame, text="Logout", fg_color="#3B3B3B", command=self.logout).pack(side="left", padx=5)
